...
class NinjasControllerTest < ActionController::TestCase
  ...
  test "should create ninja" do
    assert_difference('Ninja.count') do
      post :create, ninja: { clan_id: @ninja.clan_id, desc: @ninja.desc, fb: @ninja.fb, name: @ninja.name, tw: @ninja.tw }
    end
  ...
  test "should update ninja" do
    put :update, id: @ninja, ninja: { clan_id: @ninja.clan_id, desc: @ninja.desc, fb: @ninja.fb, name: @ninja.name, tw: @ninja.tw }
    assert_redirected_to ninja_path(assigns(:ninja))
  end
